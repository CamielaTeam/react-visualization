...
ReactParser.prototype.program = function () {
  ...
  try {
    ...
    while (
      _la === ReactParser.IMPORT ||
      _la === ReactParser.FUNCTION ||
      _la === ReactParser.ID
    ) {
      this.state = 52;
      this.program_body();
...
Program_bodyContext.prototype = Object.create(
...
Import_statementContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
No_id_importContext.prototype = Object.create(
  Import_statementContext.prototype
);
...
Html_elementsContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
Html_short_elementContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
Possible_assignContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
        ...
        ((_la & ~0x1f) == 0 &&
          ((1 << _la) &
            ((1 << ReactParser.NULL) |
              ...
              (1 << ReactParser.FALSE))) !==
            0) ||
        _la === ReactParser.STRING ||
        _la === ReactParser.INTEGER
      )
    ) {
...
Value_html_tagContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
Adding_proptypesContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
Prop_types_bodyContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
...
Types_of_proptypesContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
  ...
  try {
    ...
    if (
      !(
        ((_la - 26) & ~0x1f) == 0 &&
        ((1 << (_la - 26)) &
          ((1 << (ReactParser.ARRAY - 26)) |
            (1 << (ReactParser.BOOL - 26)) |
            (1 << (ReactParser.FUNC - 26)) |
            (1 << (ReactParser.NUMBER - 26)) |
            (1 << (ReactParser.OBJECT - 26)) |
            (1 << (ReactParser.STRING_TYPE - 26)) |
            (1 << (ReactParser.SYMBOL - 26)))) !==
          0
      )
    ) {
      this._errHandler.recoverInline(this);
      ...
      case ReactParser.FOR:
        ...
        if (
          !(
            ((_la - 14) & ~0x1f) == 0 &&
            ((1 << (_la - 14)) &
              ((1 << (ReactParser.OPEN_TAG - 14)) |
                (1 << (ReactParser.CLOSE_TAG - 14)) |
                (1 << (ReactParser.ES_IGUAL - 14)) |
                (1 << (ReactParser.ES_DIFERENTE - 14)))) !==
              0
          )
        ) {
          this._errHandler.recoverInline(this);
        ...
        _la = this._input.LA(1);
        if (
          !(_la === ReactParser.INCREMENTAR || _la === ReactParser.DECREMENTAR)
        ) {
          this._errHandler.recoverInline(this);
        } else {
          this._errHandler.reportMatch(this);
...
Simple_stmtContext.prototype = Object.create(
  antlr4.ParserRuleContext.prototype
);
    ...
    switch (la_) {
      ...
      case 3:
        ...
        if (
          ...
          (((_la - 42) & ~0x1f) == 0 &&
            ((1 << (_la - 42)) &
              ((1 << (ReactParser.NOT - 42)) |
                (1 << (ReactParser.MENOS - 42)) |
                (1 << (ReactParser.ID - 42)) |
                (1 << (ReactParser.STRING - 42)) |
                (1 << (ReactParser.INTEGER - 42)))) !==
              0)
        ) {
          this.state = 338;
          this.expr(0);
  ...
  try {
    ...
    do {
      ...
      (((_la - 33) & ~0x1f) == 0 &&
        ((1 << (_la - 33)) &
          ((1 << (ReactParser.IF - 33)) |
            (1 << (ReactParser.BREAK - 33)) |
            (1 << (ReactParser.NOT - 33)) |
            (1 << (ReactParser.WHILE - 33)) |
            (1 << (ReactParser.FOR - 33)) |
            (1 << (ReactParser.MENOS - 33)) |
            (1 << (ReactParser.ID - 33)) |
            (1 << (ReactParser.STRING - 33)) |
            (1 << (ReactParser.INTEGER - 33)))) !==
          0)
    );
  } catch (re) {
    if (re instanceof antlr4.error.RecognitionException) {
